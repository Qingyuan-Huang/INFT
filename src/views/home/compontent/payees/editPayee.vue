<template>
  <div>
    <div class="edit">
        <div class="tab">
            <div class="tab-item" v-for="(item,index) in tool" :key="index" :class="currentIndex == index ? 'is-active':''" @click="selectTab(item,index)">
                <span ><img :src="currentIndex == index?item.imgUrl2:item.imgUrl" alt=""></span>
...
export default {
  ...
  methods:{
    ...
    save(){
        this.$confirm('Save editing, do you want to continue? ',' Prompt ',{
    ...
    cancel(){
        ...
        this.$confirm('Cancel editing, do you want to continue? ',' Prompt ',{
          confirmButtonText: 'yes',
          cancelButtonText: 'no',
          type: 'warning'
        }).then(() => {
